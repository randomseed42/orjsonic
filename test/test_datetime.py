...
class TestDateclassPassthrough:
    """
    when passthrough is enabled and default is None, orjson will raise TypeError
    orjsonic will use custom_default to encode datetime.datetime, datetime.date, and datetime.time objects,
    and return the result in format like '%Y-%m-%d %H:%M:%S'
    """
