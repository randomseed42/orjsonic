...
class TestApi:
    ...
    def test_dumps_signature(self):
        ...
        """
        assert (
            str(inspect.signature(orjson.dumps)).startswith(
                "(__obj: Any, /, default: Callable[[Any], Any] = None, option: int = None, "
            )
        )
    ...
    def test_dumps_module_str(self):
        ...
        """
        assert orjson.dumps.__module__ == "orjsonic.orjsonic"

    def test_loads_module_str(self):
        """
        orjson.loads.__module__ is a str
        """
        assert orjson.loads.__module__ == "orjsonic.orjsonic"
